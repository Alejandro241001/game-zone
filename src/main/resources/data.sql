-- Insert data into the studios table (30 registros con imagen)
INSERT IGNORE INTO studios (id, name, country, img) VALUES
(1, 'Nintendo', 'Japan', 'nintendo.png'),
(2, 'FromSoftware', 'Japan', 'fromsoftware.png'),
(3, 'Santa Monica Studio', 'United States', 'santa_monica.png'),
(4, 'CD Projekt Red', 'Poland', 'cdprojekt.png'),
(5, 'Mojang Studios', 'Sweden', 'mojang.png'),
(6, 'Rockstar Games', 'United States', 'rockstar.png'),
(7, 'Team Cherry', 'Australia', 'team_cherry.png'),
(8, 'Naughty Dog', 'United States', 'naughty_dog.png'),
(9, 'Square Enix', 'Japan', 'square_enix.png'),
(10, 'Ubisoft', 'France', 'ubisoft.png'),
(11, 'Bethesda Softworks', 'United States', 'bethesda.png'),
(12, 'Capcom', 'Japan', 'capcom.png'),
(13, 'Blizzard Entertainment', 'United States', 'blizzard.png'),
(14, 'Valve Corporation', 'United States', 'valve.png'),
(15, 'Supergiant Games', 'United States', 'supergiant.png'),
(16, 'Konami', 'Japan', 'konami.png'),
(17, 'Sega', 'Japan', 'sega.png'),
(18, 'Electronic Arts', 'United States', 'ea.png'),
(19, 'Insomniac Games', 'United States', 'insomniac.png'),
(20, 'Bandai Namco', 'Japan', 'bandai_namco.png'),
(21, 'Rare', 'United Kingdom', 'rare.png'),
(22, 'Larian Studios', 'Belgium', 'larian.png'),
(23, 'Obsidian Entertainment', 'United States', 'obsidian.png'),
(24, 'Guerrilla Games', 'Netherlands', 'guerrilla.png'),
(25, 'PlatinumGames', 'Japan', 'platinum.png'),
(26, 'IO Interactive', 'Denmark', 'io_interactive.png'),
(27, 'Activision', 'United States', 'activision.png'),
(28, 'Telltale Games', 'United States', 'telltale.png'),
(29, 'Remedy Entertainment', 'Finland', 'remedy.png'),
(30, 'Annapurna Interactive', 'United States', 'annapurna.png');

INSERT IGNORE INTO video_games (id, name, studio_id, description, metacritic, release_year, img) VALUES
(1, 'The Legend of Zelda: Breath of the Wild', 1, 'Un juego de mundo abierto con Link explorando Hyrule.', 97.0, 2017, 'Zelda.jpg'),
(2, 'Elden Ring', 2, 'Un RPG de acción en un mundo abierto creado con George R.R. Martin.', 96.0, 2022, 'EldenRing.jpg'),
(3, 'God of War Ragnarok', 3, 'La continuación épica de Kratos y Atreus en la mitología nórdica.', 94.0, 2022, 'GodOfWar.jpg'),
(4, 'Cyberpunk 2077', 4, 'Un RPG futurista en la ciudad de Night City.', 86.0, 2020, 'Cyberpunk.jpg'),
(5, 'Minecraft', 5, 'Un juego de construcción y supervivencia en un mundo de bloques.', 93.0, 2011, 'Minecraft.jpg'),
(6, 'Red Dead Redemption 2', 6, 'Una épica aventura en el Salvaje Oeste.', 97.0, 2018, 'RDR2.jpg'),
(7, 'Hollow Knight', 7, 'Un metroidvania con un mundo oscuro y hermoso.', 90.0, 2017, 'HollowKnight.jpg'),
(8, 'The Last of Us Part II', 8, 'Una historia emocional en un mundo postapocalíptico.', 93.0, 2020, 'TLOU2.jpg'),
(9, 'Final Fantasy VII Remake', 9, 'Un remake del clásico RPG con gráficos modernos.', 87.0, 2020, 'FF7Remake.jpg'),
(10, 'Assassin’s Creed Valhalla', 10, 'Una aventura vikinga en un mundo abierto.', 84.0, 2020, 'ACValhalla.jpg'),
(11, 'The Elder Scrolls V: Skyrim', 11, 'Un RPG épico en un mundo de fantasía.', 94.0, 2011, 'Skyrim.jpg'),
(12, 'Resident Evil Village', 12, 'Terror y acción en un pueblo misterioso.', 84.0, 2021, 'REVillage.jpg'),
(13, 'Overwatch', 13, 'Un shooter en equipo con héroes únicos.', 91.0, 2016, 'Overwatch.jpg'),
(14, 'Half-Life: Alyx', 14, 'Una experiencia VR revolucionaria.', 92.0, 2020, 'HLAlyx.jpg'),
(15, 'Hades', 15, 'Un roguelike mitológico con gran narrativa.', 93.0, 2020, 'Hades.jpg'),
(16, 'Metal Gear Solid V: The Phantom Pain', 16, 'Un juego de sigilo en un mundo abierto.', 93.0, 2015, 'MGSV.jpg'),
(17, 'Sonic Mania', 17, 'Un regreso a las raíces de Sonic con estilo retro.', 86.0, 2017, 'SonicMania.jpg'),
(18, 'FIFA 23', 18, 'El simulador de fútbol más popular.', 77.0, 2022, 'FIFA23.jpg'),
(19, 'Spider-Man: Miles Morales', 19, 'Una aventura de superhéroes en Nueva York.', 85.0, 2020, 'MilesMorales.jpg'),
(20, 'Dark Souls III', 20, 'Un RPG de acción desafiante y oscuro.', 89.0, 2016, 'DS3.jpg'),
(21, 'Sea of Thieves', 21, 'Aventuras piratas en un mundo multijugador.', 81.0, 2018, 'SeaOfThieves.jpg'),
(22, 'Baldur’s Gate 3', 22, 'Un RPG profundo basado en Dungeons & Dragons.', 96.0, 2023, 'BG3.jpg'),
(23, 'The Outer Worlds', 23, 'Un RPG de ciencia ficción con humor.', 85.0, 2019, 'OuterWorlds.jpg'),
(24, 'Horizon Forbidden West', 24, 'Una aventura en un mundo postapocalíptico con robots.', 88.0, 2022, 'HorizonFW.jpg'),
(25, 'Bayonetta 3', 25, 'Acción estilizada con una bruja poderosa.', 88.0, 2022, 'Bayonetta3.jpg'),
(26, 'Hitman 3', 26, 'Sigilo y asesinatos creativos en entornos globales.', 87.0, 2021, 'Hitman3.jpg'),
(27, 'Call of Duty: Modern Warfare II', 27, 'Un shooter militar intenso.', 79.0, 2022, 'CODMW2.jpg'),
(28, 'The Walking Dead: Season 1', 28, 'Una narrativa interactiva emocionante.', 92.0, 2012, 'TWD.jpg'),
(29, 'Alan Wake II', 29, 'Terror psicológico con una gran historia.', 89.0, 2023, 'AlanWake2.jpg'),
(30, 'Stray', 30, 'Una aventura como gato en un mundo cyberpunk.', 83.0, 2022, 'Stray.jpg');
