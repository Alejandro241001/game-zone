...
hayas jugado, consultar detalles como notas de Metacritic, leer y escribir
reseñas. La página ofrecerá funcionalidades como listas personalizadas, nota
de cualquier videojuego que esté en la base de datos, dejar una reseña propia
y puntuar el propio videojuego. El proyecto contará con tres Roles(usuario no
registrado, usuario registrado y administrador).
